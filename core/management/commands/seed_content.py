...
class Command(BaseCommand):
    ...
    # Houses_58006-2465.json. Переносы строк не закрепляем: в макете
    # абзац занимает 4 строки при ширине 1240, браузер даёт их сам.
    HOUSES_INTRO = (
