...
DEFAULT_SERVICES_INTRO = (
    ...
    "фотосессия с животными. Скажите заранее — подготовим к вашему приезду."
)
...
STALE_SERVICES_INTRO = {
    ...
    "Описание доп услуг за дополнительную плату. "
    "Можно добавить сюда те самые якоря.",
    # Тот же текст с переносом по прежней версии макета (до Houses.svg
    # 4282): его засевал seed_content, в новом макете строка рвётся после
    # «беседка,».
    "Чем можно разнообразить ваш отдых: русская баня, беседка, "
